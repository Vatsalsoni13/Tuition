...
const Assignment = ({item, navigation, screen, batchId}) => {
  return (
    <TouchableOpacity
      // key={index}
      onPress={() => {
        navigation.navigate(`${screen}`, {assignment: item, batchId: batchId});
      }}>
      <View
        style={{
          flex: 1,
        ...
        <LinearGradient colors={['#eff8ff', '#a7c5eb']} style={{flex: 1}}>
